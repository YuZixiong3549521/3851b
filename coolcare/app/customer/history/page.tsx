  ...
  return (
    <CoolCareShell>
      <div className="mx-auto max-w-5xl px-5 py-8 sm:px-8 lg:px-10 lg:py-10">
        <div className="mb-8 flex flex-wrap items-end justify-between gap-4"><div><p className="text-sm font-semibold text-primary">HISTORY</p><h1 className="mt-1 text-3xl font-bold tracking-tight">Booking history</h1><p className="mt-2 text-sm text-muted-foreground">Review completed visits, technician reports and cancelled requests.</p></div><Button nativeButton={false} render={<Link href="/customer/book" />} variant="outline"><CalendarPlus className="size-4" aria-hidden="true" />Book another visit</Button></div>
