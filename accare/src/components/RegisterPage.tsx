    ...
    <div className="w-full flex-grow bg-surface-container-low py-8 sm:py-12 md:py-16 px-4 sm:px-6 flex flex-col justify-center items-center relative overflow-hidden">
      ...
      <div className="w-full max-w-[560px] mx-auto relative z-10">
        ...
        <div className="bg-surface rounded-2xl shadow-md border border-outline-variant/40 p-6 sm:p-8 backdrop-blur-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-on-surface mb-1.5" htmlFor="reg-phone">
                  Phone Number
                </label>
                <div className="relative">
                  <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-outline text-[20px]">
            ...
            <div>
              <label className="block text-sm font-medium text-on-surface mb-1.5" htmlFor="reg-property">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full pl-10 pr-8 py-2.5 rounded-lg border border-outline-variant bg-surface-container-lowest text-on-surface focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 text-sm appearance-none cursor-pointer"
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-on-surface mb-1.5" htmlFor="reg-confirm-password">
                  Confirm Password
                </label>
                <div className="relative">
                  <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-outline text-[20px]">
            ...
            <div className="pt-2">
              <label className="flex items-start gap-2.5 cursor-pointer select-none">
                <input
                  ...
                  className="w-4 h-4 mt-0.5 rounded text-primary focus:ring-primary border-outline-variant accent-primary cursor-pointer shrink-0"
                />
                <span className="text-xs text-on-surface-variant leading-normal">
                  I agree to AC Care's{' '}
                  <span className="text-primary font-medium underline">Terms of Service</span> and{' '}
                  <span className="text-primary font-medium underline">Privacy Policy</span>, and consent to service notification SMS/emails.
                </span>
              </label>
            </div>
        ...
        <div className="mt-6 grid grid-cols-3 gap-2 text-center text-xs text-on-surface-variant">
          <div className="p-2.5 bg-surface/80 rounded-xl border border-outline-variant/30 backdrop-blur-xs">
            <span className="material-symbols-outlined text-[20px] text-primary block mb-1">
              verified
            </span>
            <span className="font-medium">Certified Techs</span>
          </div>
          <div className="p-2.5 bg-surface/80 rounded-xl border border-outline-variant/30 backdrop-blur-xs">
            <span className="material-symbols-outlined text-[20px] text-tertiary-container block mb-1">
              receipt_long
            </span>
