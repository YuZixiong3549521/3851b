          ...
          <>
            <section className="relative overflow-hidden rounded-[28px] bg-[linear-gradient(115deg,#003f9f_0%,#0066ff_58%,#00a98f_125%)] px-6 py-8 text-white shadow-[0_24px_70px_rgba(0,80,203,0.18)] sm:px-9 sm:py-10">
              ...
              <div className="relative max-w-2xl">
                ...
                <Button render={<Link href="/book" />} size="lg" className="mt-7 bg-white text-primary shadow-lg hover:bg-blue-50">Book a service<ArrowRight className="size-4" aria-hidden="true" /></Button>
              </div>
            </section>
                  ...
                  {upcoming ? (
                    <>
                      ...
                      <div className="mt-5 flex flex-wrap items-center justify-between gap-3">
                        ...
                        <Button render={<Link href="/bookings" />} variant="outline">View booking</Button>
                      </div>
                    </>
                  ) : (
